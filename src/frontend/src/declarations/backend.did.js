...
export const User = IDL.Record({
  ...
  'lastActiveAt' : IDL.Opt(IDL.Int),
  'name' : IDL.Text,
  'createdAt' : IDL.Int,
  'role' : Role,
  'rejectionReason' : IDL.Opt(IDL.Text),
  'partnerLevel' : IDL.Opt(IDL.Text),
  'email' : IDL.Opt(IDL.Text),
  'referredBy' : IDL.Opt(IDL.Text),
  'rejectedAt' : IDL.Opt(IDL.Int),
  'rejectedBy' : IDL.Opt(IDL.Principal),
  'partnerRating' : IDL.Opt(IDL.Nat),
  'verificationTimestamp' : IDL.Opt(IDL.Int),
  'requestedRole' : IDL.Opt(IDL.Text),
  'verificationPartner' : IDL.Opt(IDL.Principal),
