    ...
    <div className="min-h-screen bg-[#FAFBFD]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="space-y-8">
          <div>
            <h1 className="text-3xl font-bold text-[#0F172A]">Partner Dashboard</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card>
              <CardHeader>
                <CardTitle>Profil Partner</CardTitle>
                <CardDescription>Informasi akun Anda</CardDescription>
              </CardHeader>
              <CardContent className="space-y-2">
                <div>
                  <p className="text-sm text-muted-foreground">ID Partner</p>
                ...
                <div>
                  <p className="text-sm text-muted-foreground">Kota Domisili</p>
                  <p className="font-medium">{currentUser?.kotaDomisili || '-'}</p>
                </div>
                <div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Tugas yang sedang dikerjakan</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Ringkasan performa</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex items-center justify-center h-24">
